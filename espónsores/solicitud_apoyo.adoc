...
:page-background-image: image:membrete_hacktoberfest.png[]
:nofooter:
...
Posibilidad de realizar una actividad o cuña publicitaria de 5 minutos durante las charlas del Hacktoberfest +
